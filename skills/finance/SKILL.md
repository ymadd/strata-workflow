...
2. Load the finance profile at `${CLAUDE_SKILL_DIR}/../general/reference/domains/finance.md` and merge its preset for the chosen mode into args (**caller args > profile > mode defaults**; `qualityBar`+`pitfalls` → `constraints`).
